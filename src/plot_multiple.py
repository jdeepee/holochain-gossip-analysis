...
for key, value in results.items():
    ...
    plt.savefig("../graphs/full_limbo_state_{}.jpg".format(name))
    plt.clf()
    ...
    plt.legend(loc='best')
    plt.xticks(rotation=45)
    plt.savefig("../graphs/validation_limbo_series_{}.jpg".format(name))
    plt.clf()
    ...
    plt.legend(loc='best')
    plt.xticks(rotation=45)
    plt.savefig("../graphs/integration_limbo_series_{}.jpg".format(name))
    plt.clf()
    ...
    plt.legend(loc='best')
    plt.xticks(rotation=45)
    plt.savefig("../graphs/integrated_limbo_series_{}.jpg".format(name))
    plt.clf()
